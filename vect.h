...
// CMT3 CMI3
#pragma interrupt (Excep_CMT3_CMI3(enable,vect=31))
...
// S12AD0 S12ADI0
#pragma interrupt (Excep_S12AD0_S12ADI0(enable,vect=102))
void Excep_S12AD0_S12ADI0(void);

// S12AD1 S12ADI1
#pragma interrupt (Excep_S12AD1_S12ADI1(enable,vect=103))
...
// MTU0 TGIA0
#pragma interrupt (Excep_MTU0_TGIA0(enable,vect=114))
void Excep_MTU0_TGIA0(void);

// MTU0 TGIB0
#pragma interrupt (Excep_MTU0_TGIB0(enable,vect=115))
void Excep_MTU0_TGIB0(void);

// MTU0 TGIC0
#pragma interrupt (Excep_MTU0_TGIC0(enable,vect=116))
void Excep_MTU0_TGIC0(void);

// MTU0 TGID0
#pragma interrupt (Excep_MTU0_TGID0(enable,vect=117))
