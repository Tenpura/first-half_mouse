...
const unsigned int parameter::ideal_photo[2][4] = { { 2400, 1200, 10815, 10100 }, { 100,
		100, 100, 100 } };
const unsigned int parameter::min_wall_photo[2][4]={{2200,1120,0,0},{0,0,0,0}};


//0番目は探索用
const TRAPEZOID parameter::straight_run[RUN_MODE_NUMBER] = { { 2.0, 0.5, 2.0 },
